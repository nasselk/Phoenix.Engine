...
class Vector2D {
    ...
    rotate(angle, point = Vector2D.NULL) {
...
Vector2D.NULL = Object.freeze(new Vector2D());
Vector2D.TEMP1 = new Vector2D();
Vector2D.TEMP2 = new Vector2D();
Vector2D.TEMP3 = new Vector2D();
Vector2D.TEMP4 = new Vector2D();
Vector2D.TEMP5 = new Vector2D();
...
export { Vector2D as Vector, ObservableVector2D as ObservableVector };
