 ...
 */
type VectorStructure = { x: number; y: number };
...
class Vector2D {
	 ...
	 */
	public static readonly NULL: Vector2D = Object.freeze(new Vector2D());
	 ...
	 */
	public static readonly TEMP1: Vector2D = new Vector2D();
	public static readonly TEMP2: Vector2D = new Vector2D();
	public static readonly TEMP3: Vector2D = new Vector2D();
	public static readonly TEMP4: Vector2D = new Vector2D();
	public static readonly TEMP5: Vector2D = new Vector2D();
	 ...
	 */
	public set(vector: VectorStructure, scalar?: number): this;
	...
	public set(a: VectorStructure | number, b?: number): this {
		if (typeof a === "object") {
			const scalar = b ?? 1;
	 ...
	 */
	public add(vector: VectorStructure, scalar?: number): this;
	...
	public add(a: VectorStructure | number, b?: number): this {
		if (typeof a === "object") {
			const scalar = b ?? 1;
	 ...
	 */
	public subtract(vector: VectorStructure, scalar?: number): this;
	...
	public subtract(a: VectorStructure | number, b?: number): this {
		if (typeof a === "object") {
			const scalar = b ?? 1;
	 ...
	 */
	public multiply(vector: VectorStructure, scalar?: number): this;
	...
	public multiply(a: VectorStructure | number, b?: number): this {
		if (typeof a === "object") {
			const scalar = b ?? 1;
	 ...
	 */
	public divide(vector: VectorStructure, scalar?: number): this;
	...
	public divide(a: VectorStructure | number, b?: number): this {
		if (typeof a === "object") {
			const scalar = b ?? 1;
	 ...
	 */
	public interpolate(otherVec: Vector2D, t: number) {
	 ...
	 */
	public dot(vector: VectorStructure): number {
	 ...
	 */
	public cross(vector: VectorStructure): number {
	 ...
	 */
	public delta(vector: VectorStructure): Vector2D {
	 ...
	 */
	public midpoint(vector: VectorStructure): Vector2D {
		return new Vector2D((this.x + vector.x) / 2, (this.y + vector.y) / 2);
	}
	 ...
	 * @returns This vector for method chaining.
	 */
	public rotate(angle: number, point: VectorStructure = Vector2D.NULL): this {
	 ...
	 */
	public distance(vector: VectorStructure): number {
	 ...
	 */
	public distanceSquared(vector: VectorStructure): number {
		const dx = this.x - vector.x;
		const dy = this.y - vector.y;
	 ...
	 */
	public angleTo(vector: VectorStructure): number {
	 ...
	 */
	public segmentDistance(p1: Vector2D, p2: Vector2D): number {
	 ...
	 */
	public projectOnSegment(p1: Vector2D, p2: Vector2D): Vector2D {
	 ...
	 * @returns A new Vector2D representing the closest point on the segment.
	 */
	public project(p: Vector2D): Vector2D {
	 ...
	 * @returns This vector for method chaining.
	 */
	public reflect(normal: VectorStructure): this {
	 ...
	 * @returns True if both x and y components are equal.
	 */
	public equals(vector: VectorStructure): boolean;

	public equals(a: VectorStructure | number, b?: number): boolean {
		if (typeof a === "object") {
	...
	public get normal(): Vector2D {
		const vector = new Vector2D(-this.y, this.x);
