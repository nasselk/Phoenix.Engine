...
export function log(source: string, ...messages: any[]): void {
...
export function warn(source: string, ...messages: any[]): void {
	const date = formatDate();
...
export function error(source: string, ...messages: any[]): void {
	const date = formatDate();
...
export function credit(source: string, ...messages: string[]): void {
	const date = formatDate();
